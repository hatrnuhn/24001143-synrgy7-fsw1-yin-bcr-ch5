...
router.post('/', (0, express_validator_1.checkSchema)(cars_2.addUpdateCarBodySchema, ['body']), validation_1.default.addUpdateCarBody, cars_1.addCar);
...
router.put('/:id', (0, express_validator_1.checkSchema)(cars_2.carsParamIdSchema, ['params']), validation_1.default.carsParamsId, utils_1.checkIdExistence, (0, express_validator_1.checkSchema)(cars_2.addUpdateCarBodySchema, ['body']), validation_1.default.addUpdateCarBody, cars_1.updateCar);
